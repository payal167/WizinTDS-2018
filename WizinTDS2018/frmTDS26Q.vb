...
Public Class frmTDS26Q
    ...
    Public did As Long
    Public CO As String
    Dim WithEvents oChln As ClsChallan26QObj
    Dim WithEvents oDed As clsDeductee26QObj
    ...
    Private Sub cmdConvertForm26Q_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConvertForm26Q.Click
...
canerr:
    ...
    Private Sub frmTDS26Q_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        'Me.EnterTab(e)
        frmCoMst.EnterTab(e)
    End Sub
    ...
    Private Sub frmTDS26Q_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub RangDeChallans()
        ...
        For Each Itm In lvwChallan.Items
            nds = FetchDataSet("select sum(TotalTaxDeposited) as TTaxDep from Deductee26Q where ChallanID =" & Val(Itm.SubItems.Item(16).Text))
            If nds.Tables(0).Rows.Count > 0 Then
                'Records are present
    ...
    Private Sub frmTDS26Q_LostFocus(sender As Object, e As EventArgs) Handles Me.LostFocus
    ...
    Private Sub fillcboDedChallan()
        ...
        nds = FetchDataSet("select distinct challanId,BankChallanNo,DtOfChallan from Challan26Q WHERE RetnID=" & Me.Tag & " order by ChallanID")
    ...
    Public Sub lvwDeducteeHead()
        With lvwDeductee
            ...
            .Columns.Add("Id26Q", 0, HorizontalAlignment.Left)
        ...
        With oDed
            If lvwDeductee.Items.Count > 0 Then
                If lvwDeductee.SelectedIndices.Count > 0 Then
                    ...
                    .ID26Q = lvwDeductee.SelectedItems(0).SubItems(17).Text
                End If
            Else
                .ID26Q = 0
            End If
        ...
        Select Case e.KeyCode
            Case Keys.D
                If Control.ModifierKeys = Keys.Shift Then 'Keys.ShiftKey = vbCtrlMask Then
                    ...
                    If oChln.LinkDed26Q(lvwChallan.SelectedItems.Item(16).Text) = True Then
    ...
    Private Sub cmdok_Click(sender As Object, e As EventArgs) Handles cmdok.Click
        ...
        Dim ret As String
        'gridhead()
        ret = IIf(OptQ1.Checked = True, "26Q1", IIf(OptQ2.Checked = True, "26Q2", IIf(OptQ3.Checked = True, "26Q3", IIf(OptQ4.Checked = True, "26Q4", "All"))))
        ...
        If ret <> "All" Then
            ...
            Else
                ...
                sql = "SELECT DeductMst.DName, DeductMst.DPan, Sum(Deductee26Q.AmtOfPayment) AS SumOfAmtOfPayment, Sum(Deductee26Q.TaxAmt) AS SumOfTaxAmt, Sum(Deductee26Q.Surcharge) AS SumOfSurcharge, " _
              & " Sum(Deductee26Q.ECess) AS SumOfECess, Sum(Deductee26Q.TotalTaxDeposited) AS SumOfTotalTaxDeposited, " _
              & " Sum(Deductee26Q.TotalTaxDeducted) AS SumOfTotalTaxDeducted" _
              & " FROM CoMst INNER JOIN (RetnMst INNER JOIN (DeductMst INNER JOIN Deductee26Q ON DeductMst.DId = Deductee26Q.DId) ON RetnMst.RetnID = Deductee26Q.RetnID) ON (CoMst.CoID = RetnMst.CoID) AND (CoMst.CoID = DeductMst.CoID) " _
    ...
    Private Sub cmdDedAdd_Click(sender As Object, e As EventArgs) Handles cmdDedAdd.Click
        ...
        ElseIf cboRemark.SelectedIndex = 2 Then
            ...
            If cboDedSection.Text = "193" Or cboDedSection.Text = "194" Or
                cboDedSection.Text = "194A" Or cboDedSection.Text = "194EE" Then
                'ok
            Else
        ...
        If cmdDedAdd.Text = "Add" Then
            ...
            Else
                ...
                newitem.SubItems.Add(oDed.ID26Q)
        ...
        Else
            ...
            Else
                ...
                lvwDeductee.SelectedItems(0).SubItems(17).Text = oDed.ID26Q
    ...
    Private Sub cmdDedCancel_Click(sender As Object, e As EventArgs) Handles cmdDedCancel.Click
        'cmdDedCancel.CausesValidation = False
    ...
    Private Sub EditModeDeductee()
        ...
        End With
    End Sub
    Private Sub frmTDS26Q_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ' GetSecWiseCount()
    ...
    Private Sub fillcboDedChallan1(Sec As String)
        ...
        & " FROM Challan26Q WHERE (BankChallanNo<>Null or BankChallanNo<>0)" & sql1 _
        & " UNION ALL SELECT challanid,iif(isnull(BankChallanNo),Null,BankChallanNo),DtOfChallan,TotalTax" _
        & " FROM Challan26Q WHERE (Taxamt = 0 and (isnull(BankChallanNo) or BankChallanNo=0))" & sql1 _
        & " UNION ALL SELECT challanid,TranVouNo,DtOfChallan,TotalTax " _
        & " FROM Challan26Q WHERE (TranVouNo<>Null and TranVouNo<>0)" & sql1 _
        & " order by ChallanID"
        ...
        For i = 0 To nds.Tables(0).Rows.Count - 1
            nds1 = FetchDataSet("select sum(TotalTaxDeposited) as TChallan from Deductee26Q WHERE ChallanID=" & nds.Tables(0).Rows(i)("ChallanID"))
    ...
    Private Sub DeleteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DeleteToolStripMenuItem.Click
        ...
        If oChln.LinkDed26Q(lvwChallan.SelectedItems(0).SubItems(16).Text) = True Then
            MsgBox("This Record is further used, Cannot Delete", vbInformation, "Caution")
            Exit Sub
        End If
        If MsgBox("Do you want to delete this row?", vbYesNo + vbQuestion + vbDefaultButton2, "DELETE DATA") = vbYes Then
    ...
    Private Sub chkSection8_CheckedChanged(sender As Object, e As EventArgs)
        If chkSection8.Checked = False Then
            chkSection8.Checked = chkSectionClick(chkSection8.Text)
        End If
    End Sub

    Private Sub chkSection9_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection8.CheckedChanged
        If chkSection8.Checked = False Then
            chkSection8.Checked = chkSectionClick(chkSection8.Text)
        End If
    End Sub

    Private Sub chkSection10_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection9.CheckedChanged
        If chkSection9.Checked = False Then
            chkSection9.Checked = chkSectionClick(chkSection9.Text)
        End If
    End Sub

    Private Sub chkSection11_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection11.CheckedChanged
        If chkSection11.Checked = False Then
            chkSection11.Checked = chkSectionClick(chkSection11.Text)
        End If
    End Sub

    Private Sub chkSection12_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection12.CheckedChanged
        If chkSection12.Checked = False Then
            chkSection12.Checked = chkSectionClick(chkSection12.Text)
        End If
    End Sub

    Private Sub chkSection13_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection13.CheckedChanged
        If chkSection13.Checked = False Then
            chkSection13.Checked = chkSectionClick(chkSection13.Text)
        End If
    End Sub

    Private Sub chkSection14_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection14.CheckedChanged
        If chkSection14.Checked = False Then
            chkSection14.Checked = chkSectionClick(chkSection14.Text)
        End If
    End Sub

    Private Sub chkSection15_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection15.CheckedChanged
        If chkSection15.Checked = False Then
            chkSection15.Checked = chkSectionClick(chkSection15.Text)
        End If
    End Sub

    Private Sub chkSection16_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection16.CheckedChanged
        If chkSection16.Checked = False Then
            chkSection16.Checked = chkSectionClick(chkSection16.Text)
        End If
    End Sub

    Private Sub chkSection17_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection17.CheckedChanged
        If chkSection17.Checked = False Then
            chkSection17.Checked = chkSectionClick(chkSection17.Text)
        End If
    End Sub

    Private Sub chkSection18_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection18.CheckedChanged
        If chkSection18.Checked = False Then
            chkSection18.Checked = chkSectionClick(chkSection18.Text)
        End If
    End Sub

    Private Sub chkSection19_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection19.CheckedChanged
        If chkSection19.Checked = False Then
            chkSection19.Checked = chkSectionClick(chkSection19.Text)
        End If
    End Sub

    Private Sub chkSection20_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection20.CheckedChanged
        If chkSection20.Checked = False Then
            chkSection20.Checked = chkSectionClick(chkSection20.Text)
        End If
    End Sub

    Private Sub chkSection21_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection21.CheckedChanged
        If chkSection21.Checked = False Then
            chkSection21.Checked = chkSectionClick(chkSection21.Text)
        End If
    End Sub

    Private Sub chkSection22_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection22.CheckedChanged
        If chkSection22.Checked = False Then
            chkSection22.Checked = chkSectionClick(chkSection22.Text)
        End If
    End Sub

    Private Sub chkSection23_CheckedChanged(sender As Object, e As EventArgs) Handles chkSection23.CheckedChanged
        If chkSection23.Checked = False Then
            chkSection23.Checked = chkSectionClick(chkSection23.Text)
        End If
    End Sub
    ...
    Private Sub cboRemark_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboRemark.SelectedIndexChanged
        If cboRemark.SelectedIndex = 2 Then
            ...
            If cboDedSection.Text = "193" Or cboDedSection.Text = "194" Or cboDedSection.Text = "194D" Or cboDedSection.Text = "194J" Or
        cboDedSection.Text = "194A" Or cboDedSection.Text = "194EE" Or cboDedSection.Text = "194DA" Or cboDedSection.Text = "2AA" Then
                dtpTDSDedDt.Text = "  /  /"
    ...
    Private Sub expexcel()
        ...
        '    xlSheet.Cells(2, 5) = frdt.Value
        xlSheet.Cells(2, 5) = IIf(OptQ1.Checked = True, "26Q1", IIf(OptQ2.Checked = True, "26Q2", IIf(OptQ3.Checked = True, "26Q3", IIf(OptQ4.Checked = True, "26Q4", "All Quarter"))))
    ...
    Private Sub cmdDedDExcel_Click(sender As Object, e As EventArgs) Handles cmdDedDExcel.Click
        ...
        With lvwDeductee
            ...
            Next d
            'xlSheet.Range(xlSheet.Cells(3, 15), xlSheet.Cells(3, 15)).BorderAround()
            For R = 0 To lvwDeductee.Items.Count - 1
                ...
                'xlSheet.Cells(R + 4, 16) = IIf(lvwDeductee.Items(R).SubItems(15).Text = " ", "N", lvwDeductee.Items(R).SubItems(15).Text)
            ...
            xlSheet.Range(xlSheet.Cells(R, 1), xlSheet.Cells(R, 4)).BorderAround()
...
excelerr:
    ...
    End Sub
    Public Sub Export26_2XL_ChallanWiseDeductee()
        Dim xlapp As Excel.Application
        Dim xlBook As Excel.Workbook
        Dim xlSheet As Excel.Worksheet
...
excelerr:
    ...
    Private Sub frmTDS26Q_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint
        ...
        If dpiX = 96 Then
            ...
            For Each ctrl As Control In FindALLControlRecursive(allCtrl, Me)
                ...
                If TypeOf ctrl Is Label Or TypeOf ctrl Is CheckBox Then 'Or TypeOf ctrl Is TextBox Or TypeOf ctrl Is Button  Or TypeOf ctrl Is RadioButton Or TypeOf ctrl Is ProgressBar Or TypeOf ctrl Is GroupBox Then
    ...
    Private Sub txtDCountSec_TextChanged(sender As Object, e As EventArgs) Handles txtDCountSec.TextChanged

    End Sub

    Private Sub cmdDedCancel_EnabledChanged(sender As Object, e As EventArgs) Handles cmdDedCancel.EnabledChanged
        ' cmdDedCancel.CausesValidation = False
    End Sub

    Private Sub cmdDedCancel_GotFocus(sender As Object, e As EventArgs) Handles cmdDedCancel.GotFocus
        ' cmdDedCancel.CausesValidation = False
    End Sub
